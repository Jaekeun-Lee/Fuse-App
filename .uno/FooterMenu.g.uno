...
public partial class FooterMenu: Fuse.Controls.Panel
{
    ...
    void InitializeUX()
    {
        ...
        temp_eb15 = new global::Fuse.Reactive.EventBinding(temp2);
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp6, temp_eb13.OnEvent);
        temp6.Bindings.Add(temp_eb13);
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp7, temp_eb14.OnEvent);
        temp7.Bindings.Add(temp_eb14);
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp8, temp_eb15.OnEvent);
        temp8.Bindings.Add(temp_eb15);
