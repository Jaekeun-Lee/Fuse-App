...
public partial class UserMenu: Fuse.Controls.Panel
{
    ...
    void InitializeUX()
    {
        ...
        temp_eb19 = new global::Fuse.Reactive.EventBinding(temp);
        var temp7 = new global::Icon.Map();
        temp_eb20 = new global::Fuse.Reactive.EventBinding(temp1);
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp6, temp_eb19.OnEvent);
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp7, temp_eb20.OnEvent);
        temp7.Bindings.Add(temp_eb20);
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp8, temp_eb21.OnEvent);
        temp8.Bindings.Add(temp_eb21);
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp9, temp_eb22.OnEvent);
        temp9.Bindings.Add(temp_eb22);
